...
_ST="Kanagawa"
sbj=(
admin';'admin';'${_L}';'system:masters';'"Kubernetes The Hard Way"';'${_C}';'""
...
kube-controller';'system:kube-controller-manager';'${_C}';'${_L}';'system:kube-controller-manager';'"Kubernetes The Hard Way"';'${_Kanagawa}';'""
